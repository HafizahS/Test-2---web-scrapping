...
public class Test2 {
    ...
    {    
        try{
        Document doc = Jsoup.connect("https://en.wikipedia.org/wiki/Java_(software_platform)").get();
        ...
        System.out.println("\nTotal Contents in Java Programming Wikipedia : " + toc2.size());
        
       // System.out.println("\nTotal Contents in Java Programming Wikipedia : " + toc.outerHtml());
        for(Element step : toc)
        {
            ...
            // get all pictures in Java 
            Elements images = doc.select("img[src~=(?i)\\.(png|jpe?g|gif)]");
        
            System.out.println("\nTotal Images in Java Programming Wikipedia : " + images.size());
           ...
           // Document doc2 = Jsoup.connect("https://en.wikipedia.org/wiki/Java_(software_platform))#References").get();
            System.out.println("\nTotal References in Java Programming Wikipedia : " + ref2.size());
